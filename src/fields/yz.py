...
def _field_yz(self, y_axis, z_axis, x):
    """
    ...
    Ex = torch.zeros([y_axis.shape[0], Nz], dtype=self._dtype, device=self._device)
    Ey = torch.zeros([y_axis.shape[0], Nz], dtype=self._dtype, device=self._device)
    Ez = torch.zeros([y_axis.shape[0], Nz], dtype=self._dtype, device=self._device)
    Hx = torch.zeros([y_axis.shape[0], Nz], dtype=self._dtype, device=self._device)
    Hy = torch.zeros([y_axis.shape[0], Nz], dtype=self._dtype, device=self._device)
    Hz = torch.zeros([y_axis.shape[0], Nz], dtype=self._dtype, device=self._device)
